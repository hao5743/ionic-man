...
import { TopicInterface, ReplyInterface, UserInterface } from '../../interface/index';
...
export class TopicPage {
    ...
    init() {
        ...
        if (this.paramTopic) {
            ...
            t.good = p.good;
            t.top = p.top;
            t.reply_count = p.reply_count;
            t.visit_count = p.visit_count;
            t.create_at = p.create_at;
        }
        this.getLoginUser();
    }
    getLoginUser() {
